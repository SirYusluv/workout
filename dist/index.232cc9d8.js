...
var _map = require("./view/map");
var _mapDefault = parcelHelpers.interopDefault(_map);
var _sideNavView = require("./view/sideNavView");
var _sideNavViewDefault = parcelHelpers.interopDefault(_sideNavView);
var _pagination = require("./view/pagination");
...
const subscribeMapClickHandler = function() {
    _mapDefault.default.addClickHandler(function(e) {
        ({ lat , lng  } = e.latlng);
        _sideNavViewDefault.default.displayForm();
        _sideNavViewDefault.default.focusDurationField();
    });
};
const subscribeFormTypeChangedHandler = function() {
    _sideNavViewDefault.default.addFormTypeChangedHandler(function() {
        _sideNavViewDefault.default.toggleForm();
    });
};
const sideNavClickHandler = function(e) {
    const clickedEl = e.target.closest(".workout-info");
    if (!clickedEl) return;
    const coord = _model.state.objects.find((obj)=>obj.getId() === clickedEl.dataset.id
    ).getCoord();
    _mapDefault.default.scrollToView(coord);
    if (!(parseInt(getComputedStyle(docBody).width) <= _config.MIN_SCR_SIZE_RESP) || !sideNav.classList.contains("u-top-30")) return;
    _sideNavViewDefault.default.animateSideNav();
};
...
const formSubmitHandler = function(e) {
    ...
    type === _config.CYCLING ? _model.validateNums(distance, duration, elev) : _model.validateNums(distance, duration, cadence);
    if (!_model.state.isNum) return;
    //create a cycling or running object in state
    type === _config.CYCLING ? _model.createCycling(type, distance, duration, elev, lat, lng) : _model.createRunning(type, distance, duration, cadence, lat, lng);
    _sideNavViewDefault.default.clearFormFields();
    _sideNavViewDefault.default.hideForm();
    //save form data to storage
    _model.saveDataToStorage();
...
const displayMap = async function() {
    try {
        ...
        _mapDefault.default.showLoading();
        // //not const cause the value might change when promise get fufilled
        // let locationCords = loadLocationCords();
        await Promise.race([
            _model.loadLocationCords(),
            _helper.timeOut(_config.TIME_OUT_SEC)
        ]);
        //add a map click listener after instatiating map
        _mapDefault.default.renderMap(_model.state.coord, subscribeMapClickHandler);
        ...
        _mapDefault.default.showErrorMessage(err.message);
    } finally{
        //remove loading spinner
        _mapDefault.default.removeLoading();
    }
};
const displayFormMapAndPagi = function(next_prev) {
    _model.getDataToDisplay(next_prev); // data will be stored in state
...
const removeMarkersAndWorkout = function() {
    _sideNavViewDefault.default.removePreviousWorkouts();
    _mapDefault.default.removePreviousMarkers();
};
const renderForm = function() {
    _model.state.toDisplay.map((obj)=>{
        _sideNavViewDefault.default.render(obj);
        _mapDefault.default.renderPopup(obj);
    });
};
const displayPagi = function() {
    if (_model.state.totalPagiNum === 1) {
        console.log(1);
        _paginationDefault.default.renderNone();
        return;
    }
    if (_model.state.currPagiNum != 1 && _model.state.currPagiNum != _model.state.totalPagiNum) {
        _paginationDefault.default.renderBoth();
        return;
    }
    if (_model.state.currPagiNum === 1 && _model.state.totalPagiNum > 1) {
        _paginationDefault.default.renderNext();
        return;
    }
    if (_model.state.currPagiNum === _model.state.totalPagiNum && _model.state.currPagiNum > 1) {
        _paginationDefault.default.renderPrev();
        return;
    }
};
const initSavedForm = function() {
    _model.getDataFromStorage();
};
//for initialization
(function() {
    _paginationDefault.default.renderNone();
    _paginationDefault.default.setNextClickHandler(nextClickedHandler);
    _paginationDefault.default.setPrevClickHandler(prevClickedHandler);
    displayMap();
    _sideNavViewDefault.default.addClickHandler(sideNavAnimateHandler);
    _sideNavViewDefault.default.addSideNavClickHandler(sideNavClickHandler);
    _sideNavViewDefault.default.addFormSubmitHandler(formSubmitHandler);
    if (parseInt(getComputedStyle(docBody).width) <= _config.MIN_SCR_SIZE_RESP) _sideNavViewDefault.default.removeFooterAndPagiDisplay();
    //TODO: fetch data from storage and display on screen
    subscribeFormTypeChangedHandler();
})();

},{"core-js/stable":"eIyVg","regenerator-runtime":"cH8Iq","./helper":"4IhZr","./config":"kjqCk","./model":"7gFI5","./view/map":"2jaoM","./view/sideNavView":"9hgBs","./view/pagination":"lGbcG","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"eIyVg":[function(require,module,exports) {
...
},{}],"4IhZr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
parcelHelpers.export(exports, "calcPace", ()=>calcPace
);
parcelHelpers.export(exports, "calcSpeeed", ()=>calcSpeeed
);
...
},{"regenerator-runtime/runtime":"cH8Iq","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"JacNc":[function(require,module,exports) {
...
},{}],"kjqCk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "TILE_URL", ()=>TILE_URL
);
parcelHelpers.export(exports, "MAPID", ()=>MAPID
);
...
parcelHelpers.export(exports, "STORAGENAME", ()=>STORAGENAME
);
parcelHelpers.export(exports, "DATA_PER_PAGE", ()=>DATA_PER_PAGE
);
...
parcelHelpers.export(exports, "MIN_SCR_SIZE_RESP", ()=>MIN_SCR_SIZE_RESP
);
const MONTHS = [
    "January",
    "Febuary",
...
parcelHelpers.export(exports, "loadLocationCords", ()=>loadLocationCords
);
parcelHelpers.export(exports, "validateNums", ()=>validateNums
);
parcelHelpers.export(exports, "createCycling", ()=>createCycling
);
parcelHelpers.export(exports, "createRunning", ()=>createRunning
);
parcelHelpers.export(exports, "saveDataToStorage", ()=>saveDataToStorage
);
parcelHelpers.export(exports, "getDataFromStorage", ()=>getDataFromStorage
);
parcelHelpers.export(exports, "getDataToDisplay", ()=>getDataToDisplay
);
var _runtime = require("regenerator-runtime/runtime");
var _helper = require("./helper");
var _config = require("./config");
var _cycling = require("./Objects/cycling");
var _cyclingDefault = parcelHelpers.interopDefault(_cycling);
var _running = require("./Objects/running");
...
const validateNums = function(...nums) {
    state.isNum = _helper.isNumber(nums);
};
const createCycling = function(type, distance, duration, elev, lat, lng, id, date) {
    const cyc = new _cyclingDefault.default(type, distance, duration, elev, lat, lng, id, date);
    // state.object = cyc;
    state.objects.push(cyc);
};
const createRunning = function(type, distance, duration, cadence, lat, lng, id, date) {
    const run = new _runningDefault.default(type, distance, duration, cadence, lat, lng, id, date);
    // state.object = run;
...
const getDataFromStorage = function() {
    ...
    storage.map(function(obj) {
        obj._type === _config.RUNNING ? createRunning(obj._type, obj._distance, obj._duration, obj._cadence, obj._latLng.lat, obj._latLng.lng, obj._id, obj._date) : createCycling(obj._type, obj._distance, obj._duration, obj._elev, obj._latLng.lat, obj._latLng.lng, obj._id, obj._date);
    // handler();
    });
};
...
},{"regenerator-runtime/runtime":"cH8Iq","./helper":"4IhZr","./config":"kjqCk","./Objects/cycling":"72wxw","./Objects/running":"5RiKT","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"72wxw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _workout = require("./workout");
var _workoutDefault = parcelHelpers.interopDefault(_workout);
class Cycling extends _workoutDefault.default {
...
},{"./workout":"2hvI4","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"2hvI4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _config = require("../config");
var _helper = require("../helper");
class Workout {
    constructor(type, distance, duration, lat, lng, id, date){
        ...
        this._speed = _helper.calcSpeeed(distance, duration);
...
},{"../config":"kjqCk","../helper":"4IhZr","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"5RiKT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _workout = require("./workout");
var _workoutDefault = parcelHelpers.interopDefault(_workout);
class Running extends _workoutDefault.default {
...
},{"./workout":"2hvI4","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"2jaoM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _config = require("../config");
const allMarker = [];
...
exports.default = new Map1();

},{"../config":"kjqCk","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"9hgBs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _config = require("../config");
class SideNavView {
...
exports.default = new SideNavView();

},{"../config":"kjqCk","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"lGbcG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Pagination {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["QbuC7","bJleg"], "bJleg", "parcelRequire42d6")
