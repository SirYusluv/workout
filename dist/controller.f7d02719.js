...
})({"ccb7f91995ed9a2406eda7966dfd674c":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "f7d02719ddb9daea62f4994e3e7e07e1";
...
},{}],"27c8d06227265284e251bf203d18173c":[function(require,module,exports) {
"use strict";
...
var _map = _interopRequireDefault(require("./view/map"));

var _sideNavView = _interopRequireDefault(require("./view/sideNavView"));

var _pagination = _interopRequireDefault(require("./view/pagination"));
...
let lat, lng; //Handler functions

const subscribeMapClickHandler = function () {
  _map.default.addClickHandler(function (e) {
    ({
      lat,
      lng
    } = e.latlng);

    _sideNavView.default.displayForm();

    _sideNavView.default.focusDurationField();
  });
};

const subscribeFormTypeChangedHandler = function () {
  _sideNavView.default.addFormTypeChangedHandler(function () {
    _sideNavView.default.toggleForm();
  });
};
...
const sideNavClickHandler = function (e) {
  ...
  const coord = _model.state.objects.find(obj => obj.getId() === clickedEl.dataset.id).getCoord();

  _map.default.scrollToView(coord);

  if (!(parseInt(getComputedStyle(docBody).width) <= _config.MIN_SCR_SIZE_RESP) || !sideNav.classList.contains("u-top-30")) return;

  _sideNavView.default.animateSideNav();
};

const sideNavAnimateHandler = function (e) {
  if (!(parseInt(getComputedStyle(docBody).width) <= _config.MIN_SCR_SIZE_RESP) || !e.target.classList.contains("side-nav")) return;

  _sideNavView.default.animateSideNav();
};

const nextClickedHandler = function () {
  displayFormMapAndPagi(_config.NEXT);
};

const prevClickedHandler = function () {
  displayFormMapAndPagi(_config.PREV);
};
...
const formSubmitHandler = function (e) {
  ...
  type === _config.CYCLING ? (0, _model.validateNums)(distance, duration, elev) : (0, _model.validateNums)(distance, duration, cadence);
  if (!_model.state.isNum) return; //create a cycling or running object in state

  type === _config.CYCLING ? (0, _model.createCycling)(type, distance, duration, elev, lat, lng) : (0, _model.createRunning)(type, distance, duration, cadence, lat, lng);

  _sideNavView.default.clearFormFields();

  _sideNavView.default.hideForm(); //save form data to storage


  (0, _model.saveDataToStorage)(); //show the last data, so currently added form is shown

  displayFormMapAndPagi(_config.LAST);
}; //Other functions
...
const displayMap = async function () {
  try {
    ...
    _map.default.showLoading(); // //not const cause the value might change when promise get fufilled
    // let locationCords = loadLocationCords();


    await Promise.race([(0, _model.loadLocationCords)(), (0, _helper.timeOut)(_config.TIME_OUT_SEC)]); //add a map click listener after instatiating map

    _map.default.renderMap(_model.state.coord, subscribeMapClickHandler); //load form from storage


    initSavedForm(); //display form and marker in their respective view

    displayFormMapAndPagi(_config.NEXT);
  } catch (err) {
    //call view to handle error
    _map.default.showErrorMessage(err.message);
  } finally {
    //remove loading spinner
    _map.default.removeLoading();
  }
};

const displayFormMapAndPagi = function (next_prev) {
  (0, _model.getDataToDisplay)(next_prev); // data will be stored in state
  // console.log(state.toDisplay);

  if (_model.state.toDisplay.length === 0) return;
...
const removeMarkersAndWorkout = function () {
  _sideNavView.default.removePreviousWorkouts();

  _map.default.removePreviousMarkers();
};

const renderForm = function () {
  _model.state.toDisplay.map(obj => {
    _sideNavView.default.render(obj);

    _map.default.renderPopup(obj);
  });
};

const displayPagi = function () {
  if (_model.state.totalPagiNum === 1) {
    console.log(1);

    _pagination.default.renderNone();

    return;
  }

  if (_model.state.currPagiNum != 1 && _model.state.currPagiNum != _model.state.totalPagiNum) {
    _pagination.default.renderBoth();

    return;
  }

  if (_model.state.currPagiNum === 1 && _model.state.totalPagiNum > 1) {
    _pagination.default.renderNext();

    return;
  }

  if (_model.state.currPagiNum === _model.state.totalPagiNum && _model.state.currPagiNum > 1) {
    _pagination.default.renderPrev();
...
(function () {
  ...
  _pagination.default.setNextClickHandler(nextClickedHandler);

  _pagination.default.setPrevClickHandler(prevClickedHandler);

  displayMap();

  _sideNavView.default.addClickHandler(sideNavAnimateHandler);

  _sideNavView.default.addSideNavClickHandler(sideNavClickHandler);

  _sideNavView.default.addFormSubmitHandler(formSubmitHandler);

  if (parseInt(getComputedStyle(docBody).width) <= _config.MIN_SCR_SIZE_RESP) _sideNavView.default.removeFooterAndPagiDisplay(); //TODO: fetch data from storage and display on screen

  subscribeFormTypeChangedHandler();
})();
},{"core-js/modules/web.immediate.js":"140df4f8e97a45c53c66fead1f5a9e92","regenerator-runtime":"e155e0d3930b156f86c48e8d05522b16","./helper":"0813c6e94fa337c944710a97d1585ad5","./config":"1898557d11834653c60b8de26f27be98","./model":"74840c3318f25b13da78c459afe13880","./view/map":"57cc51e2bfa656afeb5d08a28afdff10","./view/sideNavView":"6452bd627bee268beca36aee2cfc0a47","./view/pagination":"3648488de52fe35dbf5e869f6cff01fb"}],"140df4f8e97a45c53c66fead1f5a9e92":[function(require,module,exports) {
...
},{"../internals/classof-raw":"901e5a25291bac244011feea921975b2","../internals/global":"7e78823454e7f795898745d93279f917"}],"e155e0d3930b156f86c48e8d05522b16":[function(require,module,exports) {
/**
...
},{}],"0813c6e94fa337c944710a97d1585ad5":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.isNumber = exports.generateDate = exports.generateId = exports.calcSpeeed = exports.calcPace = exports.timeOut = exports.handleError = void 0;

const handleError = function (errMessage = "Unexpected error occureed") {
  alert(errMessage);
};
...
const calcPace = function (durationMin, distanceKm) {
  return durationMin / distanceKm;
};

exports.calcPace = calcPace;

const calcSpeeed = function (distanceKm, durationHr) {
  return (distanceKm / (durationHr / 60)).toFixed(2); //convert to min
};

exports.calcSpeeed = calcSpeeed;
...
},{}],"1898557d11834653c60b8de26f27be98":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.MIN_SCR_SIZE_RESP = exports.LAST = exports.NEXT = exports.PREV = exports.DATA_PER_PAGE = exports.STORAGENAME = exports.CYCLING = exports.RUNNING = exports.TIME_OUT_SEC = exports.MAPID = exports.TILE_URL = exports.DAYS = exports.MONTHS = void 0;
const MONTHS = ["January", "Febuary", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
exports.MONTHS = MONTHS;
const DAYS = [""];
exports.DAYS = DAYS;
const TILE_URL = 'https://{s}.tile.openstreetmap.fr/hot/{z}/{x}/{y}.png';
exports.TILE_URL = TILE_URL;
const MAPID = "mapId";
exports.MAPID = MAPID;
const TIME_OUT_SEC = 10;
exports.TIME_OUT_SEC = TIME_OUT_SEC;
const RUNNING = "Running";
exports.RUNNING = RUNNING;
const CYCLING = "Cycling";
exports.CYCLING = CYCLING;
const STORAGENAME = "Saved Exercise";
exports.STORAGENAME = STORAGENAME;
const DATA_PER_PAGE = 7;
exports.DATA_PER_PAGE = DATA_PER_PAGE;
const PREV = "prev";
exports.PREV = PREV;
const NEXT = "next";
exports.NEXT = NEXT;
const LAST = "last"; // used to load last set of workout data and marker to screen

exports.LAST = LAST;
const MIN_SCR_SIZE_RESP = 700; // minimum screen size for sidenav responsiveness 

exports.MIN_SCR_SIZE_RESP = MIN_SCR_SIZE_RESP;
},{}],"74840c3318f25b13da78c459afe13880":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getDataToDisplay = exports.getDataFromStorage = exports.saveDataToStorage = exports.createRunning = exports.createCycling = exports.validateNums = exports.loadLocationCords = exports.state = void 0;

var _helper = require("./helper");

var _config = require("./config");

var _cycling = _interopRequireDefault(require("./Objects/cycling"));

var _running = _interopRequireDefault(require("./Objects/running"));
...
const state = {
  coord: [],
  isNum: false,
  // if the currently checked num is num
  objects: [],
  // A list of all objects // user shoudn't have access to this anymore
  object: "",
  // currently generated cycling or running object
  toDisplay: [],
  // object that should be in the current side nav pagi
  currPagiNum: 0,
  totalPagiNum: 0
};
exports.state = state;

const loadLocationCords = function () {
...
exports.loadLocationCords = loadLocationCords;

const validateNums = function (...nums) {
  state.isNum = (0, _helper.isNumber)(nums);
};

exports.validateNums = validateNums;

const createCycling = function (type, distance, duration, elev, lat, lng, id, date) {
  const cyc = new _cycling.default(type, distance, duration, elev, lat, lng, id, date); // state.object = cyc;

  state.objects.push(cyc);
};

exports.createCycling = createCycling;

const createRunning = function (type, distance, duration, cadence, lat, lng, id, date) {
  const run = new _running.default(type, distance, duration, cadence, lat, lng, id, date); // state.object = run;

  state.objects.push(run);
};

exports.createRunning = createRunning;

const saveDataToStorage = function () {
  localStorage.setItem(_config.STORAGENAME, JSON.stringify(state.objects));
...
const getDataFromStorage = function () {
  const storage = JSON.parse(localStorage.getItem(_config.STORAGENAME));
  if (!storage) return;
  storage.map(function (obj) {
    obj._type === _config.RUNNING ? createRunning(obj._type, obj._distance, obj._duration, obj._cadence, obj._latLng.lat, obj._latLng.lng, obj._id, obj._date) : createCycling(obj._type, obj._distance, obj._duration, obj._elev, obj._latLng.lat, obj._latLng.lng, obj._id, obj._date); // handler();
  });
};

exports.getDataFromStorage = getDataFromStorage;

const getDataToDisplay = function (prev_next) {
  //Seven num of data per page
  state.totalPagiNum = Math.ceil(state.objects.length / _config.DATA_PER_PAGE);

  if (prev_next === _config.LAST) {
    _last();

    return;
  }

  prev_next === _config.PREV ? _prev() : _next();
}; //********** NOT EXPORTING **********//
...
const _loadPageToState = function () {
  const start = (state.currPagiNum - 1) * _config.DATA_PER_PAGE;
  const end = state.currPagiNum * _config.DATA_PER_PAGE;
  state.toDisplay = state.objects.slice(start, end);
};
},{"./helper":"0813c6e94fa337c944710a97d1585ad5","./config":"1898557d11834653c60b8de26f27be98","./Objects/cycling":"e15a3ef348c6a05ff637a660029a4910","./Objects/running":"d384f28233c669372e9199c1f9a353e8"}],"e15a3ef348c6a05ff637a660029a4910":[function(require,module,exports) {
"use strict";
...
;
},{"./workout":"20013ea5124c538cac2b1cfdbcd7056e"}],"20013ea5124c538cac2b1cfdbcd7056e":[function(require,module,exports) {
"use strict";
...
class Workout {
  constructor(type, distance, duration, lat, lng, id, date) {
    ...
    this._speed = (0, _helper.calcSpeeed)(distance, duration);
    id ? this._id = id : this._id = (Date.now() + "").slice(-10);
    const d = new Date();
    date ? this._date = date : this._date = `${_config.MONTHS[d.getMonth()]} ${d.getDate()}, ${(d.getFullYear() + "").slice(2)}`;
  }
...
;
},{"../config":"1898557d11834653c60b8de26f27be98","../helper":"0813c6e94fa337c944710a97d1585ad5"}],"d384f28233c669372e9199c1f9a353e8":[function(require,module,exports) {
"use strict";
...
;
},{"./workout":"20013ea5124c538cac2b1cfdbcd7056e"}],"57cc51e2bfa656afeb5d08a28afdff10":[function(require,module,exports) {
"use strict";
...
class Map {
  constructor() {
    _defineProperty(this, "_iconLoad", document.querySelector(".side-nav__loading--map"));

    _defineProperty(this, "_mapZoomLevel", 13);
  ...
  renderMap(coord, handler) {
    this._map = L.map(_config.MAPID).setView(coord, this._mapZoomLevel);
    L.tileLayer(_config.TILE_URL, {
  ...
  renderPopup(obj) {
    const marker = L.marker(obj.getCoord()).addTo(this._map).bindPopup(L.popup({
      maxWidth: 150,
      minWidth: 80,
      autoClose: false,
      closeOnClick: false //className: `side-nav__main side-nav__main--border-${obj.getType() === RUNNING ? "cyc" : "run"}`
...
},{"../config":"1898557d11834653c60b8de26f27be98"}],"6452bd627bee268beca36aee2cfc0a47":[function(require,module,exports) {
"use strict";
...
class SideNavView {
  constructor() {
    _defineProperty(this, "_formContainer", document.querySelector(".side-nav__form-container"));

    _defineProperty(this, "_form", document.querySelector(".side-nav__form"));

    _defineProperty(this, "_submitBtn", document.querySelector(".side-nav__submit"));

    _defineProperty(this, "_footer", document.querySelector(".side-nav__footer"));

    _defineProperty(this, "_pagi", document.querySelector(".next-prev__btn"));

    _defineProperty(this, "_sideNav", document.querySelector(".side-nav"));

    _defineProperty(this, "_distanceField", this._form.querySelector(".side-nav__input--distance"));

    _defineProperty(this, "_durationField", this._form.querySelector(".side-nav__input--duration"));

    _defineProperty(this, "_elevField", this._form.querySelector(".side-nav__input--elev"));

    _defineProperty(this, "_cadenceField", this._form.querySelector(".side-nav__input--cadence"));

    _defineProperty(this, "_elev", this._form.querySelector(".side-nav__item--elev"));

    _defineProperty(this, "_cadence", this._form.querySelector(".side-nav__item--cadence"));
  }
  ...
  render(toRender) {
    const markUp = `
            <li class="workout-info side-nav__main side-nav__main--border-${toRender.getType() === _config.RUNNING ? "run" : "cyc"} u-margin-top-small u-no-opacity u-no-display js--just-added"  data-id=${toRender.getId()}>
                ...
                <div class="workout-info__div-main u-margin-top-small">
                    ...
                    ${toRender.getType() === _config.RUNNING ? `<p class="workout-info__p-text">🚅 ${toRender.getCadence()} m</p>` : `<p class="workout-info__p-text">🐾 ${toRender.getElev()} m</p>`}
                </div>
            </li>
        `;
...
exports.default = _default;
},{"../config":"1898557d11834653c60b8de26f27be98"}],"3648488de52fe35dbf5e869f6cff01fb":[function(require,module,exports) {
"use strict";
...
class Pagination {
  constructor() {
    _defineProperty(this, "_prevBtn", document.querySelector(".next-prev__arr--l"));

    _defineProperty(this, "_nextBtn", document.querySelector(".next-prev__arr--r"));

    _defineProperty(this, "_nextPrev", document.querySelector(".next-prev__btn"));
  }
...
exports.default = _default;
},{}]},{},["ccb7f91995ed9a2406eda7966dfd674c","27c8d06227265284e251bf203d18173c"], null)

//# sourceMappingURL=controller.f7d02719.js.map
